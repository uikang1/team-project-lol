...
import { changeInput, onAdd, resetForm } from '../../store/modules/communitySlice';

const CommunityAdd = () => {
    const { name, title, myposition, findposition, tier, desc } = useSelector(
    ...
    const onSubmit = (e) => {
        ...
        dispatch(onAdd({ name, title, myposition, findposition, tier, desc }));
        navigate('/community');
        dispatch(resetForm());
    };
